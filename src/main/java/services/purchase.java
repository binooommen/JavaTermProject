...
public class purchase {
    ...
    public String doGet() {
        return getResults("SELECT * FROM purchase");
    }
    ...
    public String doGet(@PathParam("id") String id) {
        return getResults("SELECT * FROM purchase WHERE id = ?", id);
    }
    ...
    public void doPut(@PathParam("id") String id, String str) {
        ...
        doPostOrPutOrDelete("UPDATE purchase SET product_id = ?, quantity = ?"
                + ", total = ?, note = ? WHERE id = ?",
    ...
    public void doDelete(@PathParam("id") String id, String str) {
        doPostOrPutOrDelete("DELETE FROM purchase WHERE id = ?", id);
    }
    ...
    private void doPostOrPutOrDelete(String query, String... params) {
        ...
        getResults("SELECT * FROM purchase");
    }
